...
>     const lecturesData = [
          {
              ...
              <p>Barotrauma to uszkodzenie tkanek, które wynika z nadmiernej różnicy ciśnień między przestrzenią gazową
 w ciele a ciśnieniem otoczenia. Zrozumienie tego zjawiska jest fundamentalne, ponieważ woda nie jest naturalnym środow
iskiem człowieka.</p>
              <h3>1. Fizyczne Podstawy Barotraumy: Prawo Boyle’a-Mariotte’a</h3>
              <p>Wszystkie urazy ciśnieniowe są ściśle związane z Prawem Boyle’a-Mariotte’a. Prawo to opisuje zachowani
e gazu w stałej temperaturze (przemiana izotermiczna).</p>
              <p>Prawo Boyle’a-Mariotte’a głosi, że objętość danej masy gazu (V) jest odwrotnie proporcjonalna do jego 
ciśnienia bezwzględnego (p) [p<sub>1</sub>V<sub>1</sub> = p<sub>2</sub>V<sub>2</sub>].</p>
              <ul>
                  <li><strong>Ciśnienie Bezwzględne (Absolutne):</strong> W nurkowaniu do obliczeń stosuje się ciśnieni
e bezwzględne (p), które jest sumą ciśnienia atmosferycznego (p<sub>0</sub>, czyli 1 bar na powierzchni) i ciśnienia hy
drostatycznego (ciśnienia słupa wody).</li>
                  <li><strong>Wpływ Głębokości:</strong> Ciśnienie w wodzie wzrasta o około 1 bar na każde 10 metrów gł
ębokości.</li>
                  <li><strong>Nieliniowa Zmiana Objętości:</strong> Największa zmiana objętości gazu w stosunku do głęb
okości (aż o 100%) następuje w płytkiej wodzie, między 0 a 10 metrów.</li>
              </ul>
              <h4>Fazy Powstawania Barotraumy:</h4>
              <ol>
                  <li><strong>Podczas Zanurzania (Kompresja):</strong> Wraz ze wzrostem ciśnienia zewnętrznego, objętoś
ć gazu w zamkniętych przestrzeniach ciała maleje. Jeśli ciśnienie nie jest wyrównane, powstaje siła ssąca, która uszkad
za tkanki.</li>
                  <li><strong>Podczas Wynurzania (Rozprężanie):</strong> Wraz ze spadkiem ciśnienia zewnętrznego, objęt
ość gazu w zamkniętych lub częściowo zamkniętych przestrzeniach (np. płucach) rośnie. Jeśli uwięziony gaz nie ma ujścia
, rozpręża się i wywołuje siłę napierającą/rozrywającą.</li>
              </ol>
              <hr>
              <h3>2. Rodzaje Barotraumy i Mechanizmy Uszkodzeń</h3>
              <p>Barotrauma dotyczy wszystkich przestrzeni wypełnionych gazem, które są zamknięte lub mają ograniczoną 
drożność.</p>
              <h4>A. Urazy Związane głównie z Zanurzaniem (Kompresja)</h4>
              <p>Te urazy wynikają z braku dodania powietrza do przestrzeni gazowych, aby zrównoważyć wzrost ciśnienia 
otoczenia.</p>
              <h5>Uraz Ciśnieniowy Ucha Środkowego (UCU):</h5>
              <ul>
                  <li><strong>Mechanizm:</strong> Jest to najczęstszy uraz nurkowy. Ucho środkowe jest jamą gazową połą
czoną z gardłem trąbką Eustachiusza. Wzrastające ciśnienie odkształca błonę bębenkową do wewnątrz. Jeśli ciśnienie nie 
jest wyrównane, następuje bolesny efekt ssący w uchu środkowym. W skrajnych przypadkach błona bębenkowa może pęknąć.</l
i>
                  <li><strong>Objawy:</strong> Narastający ucisk, przechodzący w kłujący ból. Nagłe ustąpienie kłująceg
o bólu i dotkliwy ból spowodowany zalaniem ucha środkowego zimną i zanieczyszczoną wodą, nudności, wymioty oraz utrata 
orientacji w przestrzeni.</li>
              </ul>
              <h5>Uraz Ciśnieniowy Zatok:</h5>
              <ul>
                  <li><strong>Mechanizm:</strong> Uraz następuje, gdy ujścia zatok są niedrożne (np. z powodu kataru, z
apalenia zatok, polipów). Siła ssąca powoduje wysięk krwi z nabłonka do zamkniętej części zatoki.</li>
                  <li><strong>Objawy:</strong> Uczucie pełności i silny ból w okolicy niedrożnej zatoki. Ból głowy, któ
ry może promieniować do oczodołu lub ucha.</li>
              </ul>
              <h5>Uraz Ciśnieniowy Maski (Oczu i Twarzy):</h5>
              <ul>
                  <li><strong>Mechanizm:</strong> Maska jest przestrzenią gazową. Brak wyrównania ciśnienia w masce pod
czas zanurzania powoduje, że wzrastające ciśnienie wywołuje siłę ssącą na twarz i oczy.</li>
                  <li><strong>Skutki:</strong> Pękanie drobnych naczyń krwionośnych skóry twarzy, gałek ocznych i nosa.
 Silne krwawienie do wnętrza gałek ocznych może doprowadzić do uszkodzenia wzroku.</li>
              </ul>
              <h5>Uraz Ciśnieniowy Zęba (Barodontalgia):</h5>
              <ul>
                  <li><strong>Mechanizm (zanurzanie):</strong> Rzadkie zjawisko związane z małymi komorami powietrznymi
 uwięzionymi pod nieprawidłowo założonymi plombami lub koronkami. Kompresja uwięzionego powietrza może prowadzić do sil
nego bólu zęba (barodontalgia).</li>
              </ul>
              <h4>B. Urazy Związane głównie z Wynurzaniem (Rozprężanie)</h4>
              <p>Urazy te są wynikiem rozprężania się gazu zgodnie z Prawem Boyle’a-Mariotte’a, gdy maleje ciśnienie ot
oczenia.</p>
              <h5>Uraz Ciśnieniowy Płuc (UCP):</h5>
              <ul>
                  <li><strong>Najgroźniejszy uraz:</strong> UCP jest najgroźniejszy dla zdrowia i życia spośród wszystk
ich urazów nurkowych.</li>
                  <li><strong>Przyczyna:</strong> Powietrze zostaje całkowicie lub częściowo uwięzione w płucach podcza
s wynurzania się z aparatem oddechowym. Najczęstszą przyczyną jest wstrzymanie oddechu podczas wynurzania. UCP może wys
tąpić już przy wynurzeniu bez wydychania po pełnym wdechu z głębokości zaledwie 1 metra.</li>
                  <li><strong>Mechanizm Uszkodzenia:</strong> Rozprężające się powietrze mechanicznie uszkadza pęcherzy
ki płucne. Może to prowadzić do:
                      <ul>
                          <li>Tętniczych Zatorów Gazowych (AGE): Pęcherzyki powietrza dostają się do układu naczynioweg
o.</li>
                          <li>Odmy Opłucnowej: Powietrze dostaje się do jamy opłucnowej.</li>
                          <li>Odmy Śródpiersiowej/Podskórnej: Powietrze dostaje się do śródpiersia lub pod skórę szyi.<
/li>
                      </ul>
                  </li>
                  <li><strong>Objawy AGE w Mózgu:</strong> Utrata przytomności (często w ciągu 4-6 minut po wynurzeniu)
, ból głowy, drgawki, porażenie mięśni i paraliż, zaburzenia czuciowe (mrowienie, drętwienie) oraz zaburzenia zmysłów (
mowy, słuchu, wzroku, równowagi).</li>
              </ul>
              <h5>Uraz Ciśnieniowy Zatok (Rozprężny):</h5>
              <ul>
                  <li><strong>Mechanizm:</strong> Uwięzione powietrze rozpręża się podczas wynurzania, powodując wzrost
 ciśnienia na ściany zatoki. Ból ustępuje, gdy powietrze pokonuje opór zamkniętego ujścia.</li>
                  <li><strong>Objawy:</strong> Silny ból w okolicy zamkniętej części zatoki i możliwe wyrzucenie z nosa
 krwi, wydzieliny i powietrza.</li>
              </ul>
              <h5>Uraz Ciśnieniowy Przewodu Pokarmowego:</h5>
              <ul>
                  <li><strong>Mechanizm:</strong> Gaz uwięziony w żołądku lub jelitach (np. z połkniętego powietrza, na
pojów gazowanych) rozpręża się podczas wynurzania.</li>
                  <li><strong>Skutki:</strong> Ucisk na żołądek, cofanie się treści żołądka do przełyku i odbijanie.</l
i>
              </ul>
              <h5>Uraz Ciśnieniowy Zęba (Rozprężny):</h5>
              <ul>
                  <li><strong>Mechanizm:</strong> Trudność z wydostaniem się rozprężającego powietrza z komory pod plom
bą lub koroną.</li>
                  <li><strong>Skutki:</strong> Może dojść do odwarstwienia plomby, poluzowania koronki lub pęknięcia zę
ba.</li>
              </ul>
              <hr>
              ...
              <ul>
                  <li><strong>Ucho i Zatoki:</strong>
                      <ul>
                          <li>Wyrównuj ciśnienie często i delikatnie podczas zanurzania, szczególnie w płytkim zakresie
 głębokości.</li>
                          <li>Stosuj metody takie jak próba Valsalvy, manewr Toynbee'ego lub manewr Frenzela. Próbę Val
salvy wykonuj bez zbędnej siły.</li>
                          <li>Jeśli poczujesz narastający ucisk, zatrzymaj się, zmniejsz głębokość i spróbuj ponownie w
yrównać ciśnienie.</li>
                          <li>Nigdy nie nurkuj z katarem lub inną infekcją dróg oddechowych.</li>
                      </ul>
                  </li>
                  <li><strong>Maska:</strong> Okresowo wdmuchuj powietrze do wnętrza maski przez nos podczas zanurzania
.</li>
                  <li><strong>Zęby:</strong> Utrzymuj zęby w doskonałym stanie i regularnie odwiedzaj dentystę. W przyp
adku bólu zęba podczas zanurzania natychmiast zakończ nurkowanie.</li>
              </ul>
              <h4>Zapobieganie UCP i Urazom Rozprężnym:</h4>
              <ul>
                  <li><strong>Oddychanie:</strong> W trakcie całego nurkowania oddychaj swobodnie i nigdy nie wstrzymuj
 oddechu podczas wynurzania.</li>
                  <li><strong>Prędkość Wynurzania:</strong> Stosuj prawidłową prędkość wynurzania (zwykle nie większą n
iż 10 m/min).</li>
                  <li><strong>Stan Zdrowia:</strong> Zachowaj co najmniej miesięczną przerwę w nurkowaniu po przebytych
 chorobach układu oddechowego, takich jak zapalenie oskrzeli lub płuc.</li>
                  <li><strong>Przewód Pokarmowy:</strong> Unikaj spożywania pokarmów gazotwórczych i napojów gazowanych
 przed nurkowaniem.</li>
                  <li><strong>Aparatura:</strong> Utrzymuj dobry stan techniczny sprzętu nurkowego, w tym automatów.</l
i>
              ...
              <p>W przypadku podejrzenia poważnego urazu ciśnieniowego (UCP, zator gazowy) kluczowa jest szybkość dział
ania, ponieważ skuteczność leczenia zależy głównie od szybkości podjęcia leczenia w komorze dekompresyjnej.</p>
              <ul>
                  <li><strong>Ocena Sytuacji:</strong> Jeśli masz wątpliwości, czy objawy wskazują na UCP, potraktuj je
, jakby nimi były.</li>
                  <li><strong>Pomoc Medyczna:</strong> Wezwij pomoc medyczną i powiadom służby o konieczności transport
u poszkodowanego do komory dekompresyjnej.</li>
                  <li><strong>Tlenoterapia:</strong> Podaj poszkodowanemu 100% tlen w maksymalnym przepływie tak szybko
, jak to możliwe. Tlen jest najważniejszym lekarstwem, ponieważ poprawia utlenowanie tkanek, redukuje możliwość powstaw
ania nowych zatorów i zmniejsza średnicę pęcherzyków gazowych.</li>
                  <li><strong>Pozycja:</strong> Ułóż poszkodowanego w pozycji poziomej.</li>
                  <li><strong>Nawadnianie:</strong> Jeśli poszkodowany jest przytomny, podaj mu do 1 litra ciepłych, sł
odkich, niegazowanych napojów.</li>
                  <li><strong>Resuscytacja:</strong> Jeśli jest to konieczne, wykonaj podstawowe zabiegi resuscytacyjne
 (BLS).</li>
              </ul>`,
              quiz: [
                  {
                      ...
                      correctAnswer: 1,
                      explanation: "Wstrzymanie oddechu podczas wynurzania powoduje rozprężanie się powietrza w płucach
, co prowadzi do ich rozerwania (zgodnie z prawem Boyle'a)."
                  },
                  {
                      ...
                      correctAnswer: 0,
                      explanation: "W zakresie 0-10m ciśnienie zmienia się z 1 na 2 bary, co powoduje dwukrotną zmianę 
objętości (największą procentowo)."
                  },
                  {
...
,
                      ...
                      correctAnswer: 2,
                      explanation: "Tlen 100% pomaga zmniejszyć pęcherzyki gazu i dotlenić tkanki. Natychmiastowy trans
port do komory jest kluczowy."
                  },
                  {
                      ...
                      correctAnswer: 2,
                      explanation: "Prawo Boyle'a-Mariotte'a mówi, że objętość gazu jest odwrotnie proporcjonalna do ci
śnienia. Największe zmiany objętości występują na płytkich głębokościach."
                  },
                  {
                      question: "Którą z poniższych metod należy stosować do wyrównywania ciśnienia w uszach podczas za
nurzania?",
                      options: [
                      ...
                      correctAnswer: 3,
                      explanation: "Wszystkie te metody są skuteczne. Najważniejsze to wyrównywać ciśnienie często, del
ikatnie i zanim poczujesz dyskomfort."
                  },
                  {
                      ...
                      correctAnswer: 1,
                      explanation: "Nigdy nie forsuj wyrównywania. Zatrzymaj się, wynurz lekko i spróbuj ponownie. Przy
 uporczywych problemach przerwij nurkowanie."
                  },
                  {
                      ...
                      correctAnswer: 1,
                      explanation: "Podciśnienie w masce podczas zanurzania powoduje wciąganie tkanek twarzy i może pro
wadzić do pęknięcia drobnych naczyń krwionośnych."
                  },
                  {
                      ...
                      correctAnswer: 2,
                      explanation: "Opuchnięta błona śluzowa i zatoki blokują kanały łączące ucho środkowe z gardłem (t
rąbka Eustachiusza), uniemożliwiając wyrównywanie ciśnienia."
                  },
                  {
                      ...
                      correctAnswer: 1,
                      explanation: "Płuca są bardzo delikatne - nadciśnienie zaledwie 0.12 bara może spowodować ich roz
erwanie, dlatego NIGDY nie wstrzymuj oddechu podczas wynurzania."
                  },
                  {
                      ...
                      correctAnswer: 3,
                      explanation: "Wszystkie te czynniki mogą prowadzić do uwięzienia powietrza w płucach (air trappin
g) i zwiększać ryzyko UCP podczas wynurzania."
                  }
              ]
          },
          {
              ...
              <p>Choroba dekompresyjna (ang. Decompression Sickness – DCS), potocznie zwana chorobą kesonową, jest zesp
ołem schorzeń i objawów wywołanych przez azot wydzielający się z tkanek do krwi nurka w sposób niekontrolowany, głównie
 w formie pęcherzyków gazowych. Jest to jedno z najpoważniejszych schorzeń, zagrażających zdrowiu i życiu płetwonurków.
</p>
              <h3>1. Fizyczne Podstawy DCS: Prawo Henry’ego</h3>
              <p>DCS jest bezpośrednim wynikiem procesów absorpcji i eliminacji azotu, które są opisywane przez Prawo H
enry’ego.</p>
              <h4>Prawo Henry’ego:</h4>
              <ul>
                  <li>Mówi, że ilość gazu, która rozpuści się w cieczy (w tym w płynach ustrojowych i tkankach ciała), 
jest wprost proporcjonalna do ciśnienia parcjalnego tego gazu.</li>
              ...
              <ol>
                  <li><strong>Zanurzanie (Saturacja):</strong> Powietrze, którym oddychamy, składa się głównie z azotu 
(ponad 78%). Podczas zanurzania, ciśnienie absolutne wzrasta, a automat podaje powietrze pod ciśnieniem równym ciśnieni
u na danej głębokości. Zgodnie z Prawem Henry'ego, azot z powietrza oddechowego zaczyna dyfundować (przenikać) do krwi 
i tkanek, nasycając je. Ilość rozpuszczonego azotu zależy od czasu i głębokości nurkowania (czyli od wyższego ciśnienia
 powietrza oddechowego).</li>
                  <li><strong>Wynurzanie (Desaturacja):</strong> W miarę wynurzania ciśnienie zewnętrzne spada. Następu
je proces odwrotny – odsycanie tkanek z azotu. Azot dyfunduje z tkanek do krwi, a następnie jest usuwany w płucach z ka
żdym wydechem.</li>
                  <li><strong>Ryzyko DCS (Tworzenie Pęcherzyków):</strong> Ciało nurka toleruje określony poziom przesy
cenia, ale jeśli różnica prężności (gradient) staje się zbyt duża (np. z powodu zbyt szybkiego wynurzania), azot może s
ię uwolnić z roztworu i przejść w formę gazową (pęcherzyków) w tkankach i krwioobiegu. To właśnie te zatory gazowe, pow
stałe pierwotnie z pęcherzyków azotu, są bezpośrednią przyczyną choroby ciśnieniowej (DCS).</li>
              </ol>
              ...
              <ul>
                  <li><strong>Bóle stawowo-mięśniowe (ang. Bends):</strong> Bóle mięśniowe w okolicach dużych stawów (b
arkowego, kolanowego, skokowego) – początkowo słabe, a następnie ostre i pulsujące. Nazwa Bends pochodzi od obserwacji 
poruszania się (tzw. "krzywika") osób dotkniętych silnymi bólami stawowo-kostnymi.</li>
                  <li><strong>Objawy skórne:</strong> Swędzenie skóry kończyn, często połączone z jej zaczerwienieniem 
lub marmurkowatością (białe, sine i czerwone plamy połączone z opuchlizną). Postać skórna jest szczególnie niebezpieczn
a.</li>
                  <li><strong>Ogólne:</strong> Ogólne zmęczenie i senność, osłabienie (jak przy grypie).</li>
              </ul>
              <h4>Typ II – Postać Ciężka (DCS II)</h4>
              <p>Związana z pęcherzykami azotu we krwi (w naczyniach). Objawy neurologiczne są identyczne jak w przypad
ku tętniczych zatorów gazowych (AGE) w przebiegu urazu ciśnieniowego płuc (UCP).</p>
              <ul>
                  <li><strong>Objawy neurologiczne:</strong>
                      <ul>
                          ...
                          <li>Zaburzenia zmysłów mowy, słuchu, wzroku, równowagi (np. zawroty głowy, dzwonienie w uszac
h).</li>
                  ...
                  <li><strong>Objawy płucno-krążeniowe:</strong>
                      <ul>
                          <li>Duszność, spłycony i przyspieszony oddech, suchy kaszel, ból w klatce piersiowej (objawy 
zawału płuc/zablokowania filtra płucnego).</li>
                          <li>Objawy zawału serca (promieniujący ból za mostkiem, zaburzenia rytmu serca, szybkie i sła
be tętno, niepokój, panika, zatrzymanie pracy serca).</li>
                      </ul>
                  </li>
              </ul>
              <p><strong>Występowanie Objawów:</strong> Objawy DCS najczęściej pojawiają się między 15 minutą a 12 godz
iną po wynurzeniu, ale w ciężkich przypadkach mogą wystąpić szybciej lub, rzadko, nawet do 24–36 godzin po nurkowaniu, 
szczególnie jeśli po nurkowaniu nastąpił lot samolotem.</p>
              <h3>3. Profilaktyka i Czynniki Ryzyka</h3>
              <p>Ryzyko wystąpienia DCS istnieje, nawet pomimo przestrzegania wszystkich zasad. Profilaktyka polega na 
minimalizowaniu czynników ryzyka:</p>
              <h4>A. Technika i Planowanie Nurkowania:</h4>
              <ul>
                  <li><strong>Prędkość Wynurzania:</strong> Stosuj prawidłową prędkość wynurzania (nie większą niż 10 m
/min). Zbyt duża prędkość jest główną przyczyną DCS.</li>
                  <li><strong>Czas Nurkowania:</strong> Nurkuj w granicach limitów bezdekompresyjnych (tzw. no-deco lim
its).</li>
                  <li><strong>Przystanki Bezpieczeństwa:</strong> Zawsze wykonuj przystanek bezpieczeństwa (3–5 min na 
głębokości 3–5 m). Około 40% wypadków DCS to nurkowania bez przystanku bezpieczeństwa.</li>
                  <li><strong>Unikaj Profili Ryzykownych:</strong> Unikaj nurkowań o profilu „piłokształtnym” (jo-jo) l
ub chaotycznym. Nurkowanie rozpoczynaj od zanurzenia na największą planowaną głębokość.</li>
                  <li><strong>Nurkowania Powtórzeniowe:</strong> Zachowaj szczególną ostrożność podczas nurkowań wielok
rotnych w ciągu dnia lub wielodniowych, ponieważ zwiększają one ryzyko DCS.</li>
                  <li><strong>Lot po Nurkowaniu:</strong> Po nurkowaniu należy odczekać co najmniej 24 godziny przed lo
tem samolotem lub podróżą na wysokość powyżej 500 metrów n.p.m., aby uniknąć zwiększonego ryzyka.</li>
              </ul>
              ...
              <p>Skuteczność leczenia ciężkiej postaci DCS zależy głównie od szybkości podjęcia leczenia w komorze deko
mpresyjnej.</p>
              <h4>Kroki Pierwszej Pomocy:</h4>
              <ol>
                  <li><strong>Ocena i Wezwanie Pomocy:</strong> W przypadku podejrzenia DCS natychmiast wezwij pomoc me
dyczną (tel. 112 lub 999). Poinformuj, że podejrzewasz wypadek nurkowy i skontaktuj się z zespołem komór dekompresyjnyc
h, np. Krajowy Ośrodek Medycyny Hiperbarycznej w Gdyni (tel. 58 699 86 54 lub 58 622 51 63).</li>
                  <li><strong>Tlenoterapia:</strong> Podaj poszkodowanemu 100% tlen w maksymalnym przepływie tak szybko
, jak to możliwe.
                      <ul>
                          <li>Tlen poprawia utlenowanie tkanek, redukuje możliwość powstawania nowych zatorów oraz zmni
ejsza średnicę pęcherzyków gazowych (zarówno azotowych, jak i powietrznych).</li>
                          <li>Poszkodowanego należy zabezpieczyć w tlen podczas transportu.</li>
                      </ul>
                  </li>
                  <li><strong>Pozycja i Nawadnianie:</strong> Ułóż poszkodowanego w pozycji poziomej. Podaj poszkodowan
emu do picia ciepłe, słodkie, niegazowane napoje (jeśli jest przytomny), do 1 litra.</li>
                  <li><strong>Resuscytacja:</strong> Jeśli poszkodowany nie oddycha, wykonaj podstawowe zabiegi resuscy
tacyjne (BLS).</li>
                  <li><strong>Transport:</strong> W ciężkim przypadku DCS, transport śmigłowcem jest najszybszym sposob
em na dostarczenie nurka do komory dekompresyjnej.</li>
              </ol>
              <hr>
              <p><strong>Podsumowanie:</strong> Choroba dekompresyjna, choć rzadka przy prawidłowym nurkowaniu rekreacy
jnym, jest stanem, w którym niekontrolowana eliminacja azotu (zgodnie z Prawem Henry'ego) prowadzi do powstawania pęche
rzyków uszkadzających tkanki. Kluczem jest przestrzeganie limitów, kontrola wynurzania i szybka reakcja w przypadku wys
tąpienia objawów.</p>`,
              quiz: [
                  {
                      ...
                      correctAnswer: 2,
                      explanation: "Prawo Henry'ego mówi o rozpuszczalności gazów w cieczach pod wpływem ciśnienia, co 
jest istotą nasycania i odsycania tkanek azotem."
                  },
                  {
                      ...
                      correctAnswer: 1,
                      explanation: "Współczesne standardy zalecają prędkość nie większą niż 9-10 m/min, a w ostatniej f
azie (ostatnie 10m) nawet wolniej."
                  },
                  {
                      ...
                      correctAnswer: 1,
                      explanation: "Większość objawów DCS pojawia się w ciągu pierwszej godziny, a 98% w ciągu 24h. Nat
ychmiastowe objawy po wynurzeniu częściej sugerują UCP/AGE."
                  },
                  {
                      ...
                      correctAnswer: 2,
                      explanation: "Według Prawa Henry'ego, ilość rozpuszczonego azotu zależy od jego ciśnienia parcjal
nego (które rośnie z głębokością) i czasu ekspozycji."
                  },
                  {
                      ...
                      correctAnswer: 1,
                      explanation: "Standardowa prędkość wynurzania to nie więcej niż 10 m/min. Wolniejsze wynurzanie (
9 m/min lub mniej) dodatkowo zwiększa bezpieczeństwo."
                  },
                  {
                      ...
                      correctAnswer: 1,
                      explanation: "DCS Typ I dotyczy tkanek obwodowych (bóle zgięć, skóra). Typ II jest znacznie poważ
niejszy i obejmuje objawy neurologiczne, płucne lub wielonarządowe."
                  },
                  {
                      ...
                      correctAnswer: 1,
                      explanation: "Przystanek bezpieczeństwa znacznie redukuje ryzyko DCS, umożliwiając bezpieczne uwo
lnienie azotu z organizmu. Ok. 40% wypadków DCS to nurkowania bez przystanku."
                  },
                  {
                      ...
                      correctAnswer: 3,
                      explanation: "Wszystkie te czynniki zwiększają ryzyko DCS. Dehydracja utrudnia eliminację azotu, 
tkanka tłuszczowa gromadzi więcej azotu, a ciepło rozszerza naczynia krwionośne."
                  },
                  {
                      ...
                      correctAnswer: 2,
                      explanation: "Zaleca się odczekać minimum 18-24 godziny przed lotem (lub podróżą powyżej 500m n.p
.m.), aby zredukować ryzyko DCS spowodowane obniżonym ciśnieniem na wysokości."
                  },
                  {
                      ...
                      correctAnswer: 1,
                      explanation: "'Bends' to klasyczny objaw DCS Typ I - intensywny ból w dużych stawach (kolana, łok
cie), który zmusza poszkodowanego do trzymania stawu w pozycji zgięcia dla ulgi."
                  }
              ]
          },
          {
              ...
              <p>Prawo Daltona, zwane też Prawem Ciśnień Parcjalnych, jest obok Prawa Boyle'a i Prawa Henry'ego, jednym
 z czterech podstawowych praw gazowych, które zaawansowany nurek powinien znać. Jest ono absolutnie kluczowe do zrozumi
enia wpływu poszczególnych gazów na organizm pod wodą, zwłaszcza tlenu i azotu.</p>
  
              <h3>1. Definicja i Mechanizm Działania</h3>
              <p>Prawo Daltona mówi, że całkowite ciśnienie mieszaniny gazowej jest równe sumie ciśnień parcjalnych wsz
ystkich gazów wchodzących w jej skład.</p>
              <p>Matematycznie można to zapisać jako: P = Pg1 + Pg2 + Pg3 ...</p>
  
              <h4>Pojęcia kluczowe:</h4>
              <ul>
                  <li><strong>Ciśnienie Całkowite (Absolutne) (P lub Pt):</strong> Ciśnienie otoczenia na danej głęboko
ści, wyrażone w atmosferach absolutnych [ATA] lub barach [bar]. Stanowi sumę ciśnienia atmosferycznego (1 bar) i ciśnie
nia hydrostatycznego (ciśnienia słupa wody).</li>
                  <li><strong>Frakcja Gazu (Fg):</strong> Procentowa zawartość danego gazu w mieszaninie, wyrażona jako
 ułamek dziesiętny (np. 32% tlenu to frakcja 0,32). Frakcja gazu jest stała podczas całego nurkowania.</li>
                  <li><strong>Ciśnienie Parcjalne Gazu (Pg lub Pp):</strong> Ciśnienie, jakie wywiera dany gaz w miesza
ninie. Wartość ta zmienia się w zależności od głębokości.</li>
              </ul>
              ...
              <p>Podczas zanurzania, gdy ciśnienie absolutne (P) rośnie, indywidualne ciśnienia parcjalne gazów składow
ych (np. azotu i tlenu) również wzrastają, i to dokładnie tak samo, jak wzrasta ciśnienie absolutne.</p>
  
              <hr>
  
              <h3>2. Zastosowanie Prawa Daltona w Nurkowaniu</h3>
              <p>Ciśnienie parcjalne (a nie procentowa zawartość) gazu jest kluczowe, ponieważ to ono decyduje o fizjol
ogicznym wpływie gazu na organizmy żywe.</p>
  
              <h4>A. Toksyczność Tlenowa (Limit Bezpieczeństwa)</h4>
              <p>W nurkowaniu z powietrzem lub Nitroksem, tlen jest niezbędny do życia, ale jego nadmiar nie jest bezpi
eczny. Zbyt wysokie ciśnienie parcjalne tlenu (PO2) stwarza ryzyko wystąpienia Toksyczności Tlenowej dla Centralnego Uk
ładu Nerwowego (CNS Toxicity).</p>
              <ul>
                  <li><strong>Limit Rekreacyjny:</strong> Maksymalne zalecane ciśnienie parcjalne tlenu (PO2) podczas n
urkowań rekreacyjnych (Nitrox do 40% O2) wynosi 1,4 bar (lub ATA).</li>
                  <li><strong>Limit Absolutny:</strong> Absolutnie nieprzekraczalny limit (PO2) to 1,6 bar (lub ATA), s
tosowany w procedurach dekompresyjnych.</li>
              </ul>
              <p>Dzięki Prawu Daltona, nurek może obliczyć, jaką głębokość może osiągnąć, zanim przekroczy bezpieczny l
imit tlenu (MOD).</p>
  
              <h4>B. Obliczanie Maksymalnej Głębokości Operacyjnej (MOD)</h4>
              <p>Maksymalna Głębokość Operacyjna (MOD – Maximum Operating Depth) to największa głębokość, na którą możn
a zanurkować z daną mieszaniną gazową, nie przekraczając ustalonego ciśnienia parcjalnego tlenu (PO2).</p>
              ...
              <p>Nadrzędnym celem nurkowania Nitroxowego jest oddychanie niższą zawartością azotu. Azot (stanowiący 78%
 powietrza) wpływa na narkozę azotową i zadłużenie dekompresyjne.</p>
              <ul>
                  <li>Stosując Nitrox (np. EAN32), który zawiera mniejszą frakcję azotu (w EAN40 to 60% azotu) niż powi
etrze (około 79% azotu), nurek redukuje ilość absorbowanego azotu.</li>
                  <li>Redukcja ilości azotu, zgodnie z Prawem Daltona (niższe PN2), powoduje, że organizm akumuluje mni
ej azotu.</li>
                  <li>Prowadzi to do wydłużenia czasu bezdekompresyjnego lub zwiększenia poziomu bezpieczeństwa (mniejs
ze nasycenie azotem, mniejsze ryzyko DCS).</li>
                  <li>Koncepcja ta jest formalizowana przez Równoważną Głębokość Powietrzną (EAD), która pozwala kalkul
ować nurkowanie Nitroxowe tak, jak gdyby odbywało się na płytszej głębokości z użyciem powietrza.</li>
              </ul>
  
              <hr>
  
              <h3>3. Bezpieczeństwo i Technika (Analiza Gazu)</h3>
              <p>Ponieważ frakcja tlenu ma bezpośredni wpływ na obliczenia MOD, nurek Nitroxowy ponosi ryzyko popełnien
ia błędu obliczeniowego, który może doprowadzić do mózgowego zatrucia tlenowego (CNS).</p>
              <ul>
                  <li><strong>Analiza Mieszanki:</strong> Nurek musi samodzielnie dokonać pomiaru mieszaniny przed każd
ym nurkowaniem Nitroxowym. Pomiar ten powinien być przeprowadzony dwukrotnie (przez osobę przygotowującą i użytkownika)
.</li>
                  <li><strong>Oznaczanie Butli:</strong> Butla powinna być odpowiednio opisana, zawierając nazwę miesza
niny (NITROX), procentową zawartość tlenu (FO2), MOD, nazwisko osoby dokonującej pomiaru, jej podpis oraz datę pomiaru.
</li>
              </ul>
